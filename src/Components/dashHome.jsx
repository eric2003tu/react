    ...
    return (
        <div className="min-h-screen bg-gray-100 max-w-full w-full m-0">
                    <nav className="w-full bg-blue-600 text-white p-4 fixed top-0 z-[1000] right-0 m-0 sm:pb-[55px] sm:pr-[7px]">
                                    ...
                                    {!nav ? <AiOutlineClose size={30} className='text-white font-bold cursor-pointer justify-end justify-self-end fixed right-[10px] mt-[18px]'/> : <AiOutlineMenu size={30} className='text-white font-bold cursor-pointer justify-end justify-self-end fixed [10px] mt-[18px]'/> }
                                    </div>
